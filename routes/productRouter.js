...
const seedProducts = [
    {
        ...
        qty: 30,
        price: 500,
        category: '69947db024fa58a988fa1355',
    ...
    },
    {
        ...
        qty: 3,
        price: 800,
        category: '69947db024fa58a988fa1356',
...
productRouter.post('/', async (req, res) => {
    try {
        const products = await Product.insertMany(seedProducts) // ta5od array
...
productRouter.get('/:id', async (req, res) => {
    try {
        ...
        if(!id.match(/^[0-9a-fA-F]{24}$/))
            return res.status(500).send({message: 'the provided id is incorrect'})
